...
<!-- Mirrored from wp.hostlin.com/senior-safety/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2018 18:21:41 GMT -->
<?php include("header.php");?>
		...
		<section class="rev_slider_wrapper">
			<div id="slider1" class="rev_slider"  data-version="5.0">
				<ul>
					...
					<li data-transition="fade">
						...
						<div class="tp-caption  tp-resizeme" 
							...
							data-start="700">
							<div class="slide-content-box">
								<h1> THE BEST <span>SUPPORT</span></h1>
							</div>
						</div>
						<div class="tp-caption  tp-resizeme" 
							...
							data-start="700">
							<div class="slide-content-box">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt<br> ut labore.Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
							</div>
						</div>
						 <div class="tp-caption tp-resizeme"
		                    data-x="left" data-hoffset="20" 
		                    data-y="top" data-voffset="555"                       
		                    data-transform_idle="o:1;"                         
				...
				<li data-transition="fade">
               	 	<img src="images/slider/2.jpg"  alt="" width="1920" height="900" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
		    ...
		    <div class="container">
		        <div class="row">
		            ...
		            <div class="col-md-4">
		                <div class="single-item text-center">
		                    ...
		                    <div class="img-holder">
		                        <img src="images/feature/1.jpg" alt="Awesome Image">
		                        <div class="overlay">
		                            <div class="box">
		                                <div class="content">
		            ...
		            <div class="col-md-4">
		                <div class="single-item text-center">
		                    <a href="#">
		                        <h5>Guide Proper Fitness</h5>
		                    </a>
		                    <div class="img-holder">
		                        <img src="images/feature/2.jpg" alt="Awesome Image">
		                        <div class="overlay">
		                            <div class="box">
		                                <div class="content">
		                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
		                    ...
		                    <div class="text-holder">
		                        <p>Quas consectetur adipiscing elit audiam virtute ut, case utamur fuisset eam ut, iisque accommodare an eam. Reque blandit qui eu.</p>
		                    </div>
		                </div>
		            </div>
		            <!--End single item-->
		            ...
		            <div class="col-md-4">
		                <div class="single-item text-center">
		                    ...
		                    <div class="img-holder">
		                        <img src="images/feature/3.jpg" alt="Awesome Image">
		                        <div class="overlay">
		                            <div class="box">
		                                <div class="content">
		                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
		                    ...
		                    <div class="text-holder">
		                        <p>Pri quas audiam virtute ut, case utamur fuisset eam ut, iisque accommodare an eam. Reque blandit qui eu, cu vix nonumy volumus.</p>
		                    </div>
		                </div>
		            </div>
		            <!--End single item-->
		            ...
		            <div class="col-lg-6 col-md-12">
		                <div class="text-holder">
		                    <div class="top-text">
		                        ...
		                        <p>Exercitation ullamcoLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>  -->
		                        <h3>Who Are We?</h3>
		                        <p>iCare Coventry Ltd is dedicated towards providing the best level of care for service users. With a passion stemming from both personal and professional experience. We are committed to making the lives of service users more comfortable. We offer a home care service that is personalised to your specific needs and requirements, ensuring that you get everything that you need while still maintaining a level of independence within the comfort of your own home. Our service base covers …</p>
		                    </div>
		                     <ul class="benifit-list">
		                        <li><i class="fa fa-angle-right"></i>We are always carefull to our service </li>
		                        <li><i class="fa fa-angle-right"></i>Book and appoinment with any specialist anytime</li>
		                        <li><i class="fa fa-angle-right"></i>We offer lot of service in a best price</li>
		                        <li><i class="fa fa-angle-right"></i>Online payment seystem with different method</li>
		                    </ul>

		                    <div class="link_btn">
		                        <a href="about.php" class="thm-btn style-2">read more</a>
				...
				<div class="fact-counter">								  
					<div class="row">
						<div class="counter-outer">
							<!--Column-->
							<article class="column counter-column col-md-2 col-sm-6 col-xs-12 wow fadeIn" data-wow-duration="600ms">
								<div class="item">
									<div class="inner-box">
										<div class="icon-box">
							...
							<!--Column-->
							<article class="column counter-column col-md-2 col-sm-6 col-xs-12 wow fadeIn" data-wow-duration="900ms">
								<div class="item">
									<div class="inner-box">
										<div class="icon-box">
							...
							<!--Column-->
							<article class="column counter-column col-md-2 col-sm-6 col-xs-12 wow fadeIn" data-wow-duration="300ms">
								<div class="item">
									<div class="inner-box">
										<div class="icon-box">
		       		...
		       		<div class="row">
			            ...
			            <div class="col-md-4">
			                <div class="single-item text-center">
			                    ...
			                    <div class="img-holder">
			                        <img src="images/service/5.jpg" alt="Awesome Image">
			                        <div class="overlay">
			                            <div class="box">
			                                <div class="content">
			                                    <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
			            ...
			            <div class="col-md-4">
			                <div class="single-item text-center">
			                    ...
			                    <div class="text-holder">
			                        ...
			                        <p>Our clients are no different to you or to any of us; they just chose a different path. We don't believe that anyone with a substance misuse problem, whether it be alcohol.<!--  heroin or crack cocaine, woke up one morning and thought to themselves "You know what, I think I'll get myself addicted to something today." --></p>
			                    </div>
			                </div>
			            </div>
			            <div class="col-md-4">
			                <div class="single-item text-center">
			                    ...
			                    <div class="text-holder">
			                        ...
			                        <p>Hearing and vision loss are very common in the geriatric population, with more than 40% reporting difficulties with hearing, and more than 13% having visual impairment after the age of 65 years.</p>
			                    </div>
			                </div>
			            </div>
			            <!--End single item-->
		    ...
		    <div class="container">
		        ...
		        <div class="testimonials-slider column-carousel three-column">
		            ...
		            <article class="slide-item">
		                ...
		                <div class="author">
		                    <div class="img-box">
		                        <a href="#"><img src="images/resources/t1.jpg" alt=""></a>
		                    </div>
		                    <h4>Trump Muzaddid</h4>
		                    <a href="#"><p>Bangladesh</p></a>
		                </div>
		                
		                <div class="slide-text">
		                    <p>Audiam virtute ut, case utamur fuisset eam ut, iisque accommodare an eam. Reque blandit qui eu, cu vix nonumy volumus.</p>
		                </div>
		            </article>
		            ...
		            <article class="slide-item">
		                ...
		                <div class="author">
		                    <div class="img-box">
		                        <a href="#"><img src="images/resources/t2.jpg" alt=""></a>
		                    </div>
		                    <h4>Robart Hafizur</h4>
		                    <a href="#"><p>Pakisthan</p></a>
		                </div>
		            ...
		            <article class="slide-item">
		                ...
		                <div class="author">
		                    <div class="img-box">
		                        <a href="#"><img src="images/resources/t3.jpg" alt=""></a>
		                    </div>
		                    <h4>Sufia Kamal</h4>
		                    <a href="#"><p>India</p></a>
		                </div>
		...
		<section class="contact_details sec-padd">
				...
				<div class="home-google-map">
					<div 
						...
						data-map-lat="52.419835" 
						data-map-lng="-1.506674"
...
<!-- Mirrored from wp.hostlin.com/senior-safety/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jan 2018 18:23:14 GMT -->
</html>
