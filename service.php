				...
				<div class="team-carousel">
					<div class="single-team-member">
	                    ...
	                    <div class="author-info">
	                        <a href="expart-details.html"><h4>Albart Muzaddid</h4></a>
	                        <p>Founder</p>
	                        <ul>
	                            <li><i class="fa fa-phone"></i>Phone: +123-456-7890</li>
	                            <li><i class="fa fa-envelope"></i><a href="#">SeniorSafety@gmail.com</a></li>
	                        </ul>
	                    </div>
					...
					<div class="single-team-member">
	                    ...
	                    <div class="author-info">
	                        <a href="expart-details.html"><h4>Tisha Ahmed</h4></a>
	                        <p>Co-Founder</p>
	                        <ul>
	                            <li><i class="fa fa-phone"></i>Phone: +123-456-7890</li>
	                            <li><i class="fa fa-envelope"></i><a href="#">SeniorSafety@gmail.com</a></li>
					...
					<div class="single-team-member">
	                    ...
	                    <div class="author-info">
	                        <a href="expart-details.html"><h4>Denial Nuruddin</h4></a>
					...
					<div class="single-team-member">
	                    ...
	                    <div class="author-info">
	                        <a href="expart-details.html"><h4>Farzana Rahman</h4></a>
	                        <p>Chief Editor</p>
	                        <ul>
	                            <li><i class="fa fa-phone"></i>Phone: +123-456-7890</li>
	                            <li><i class="fa fa-envelope"></i><a href="#">SeniorSafety@gmail.com</a></li>
